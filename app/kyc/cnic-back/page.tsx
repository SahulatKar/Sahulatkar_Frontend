...
export default function CNICBackCapture() {
  const [isCaptured, setIsCaptured] = useState(false)

  const extractedData = {
    mrzZone: 'IDPAK001234567<920101017M2512316<<<<',
    address: 'House No. 124, Sector F-10/2, Islamabad, ICT, Pakistan',
    verified: true,
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 sm:p-12">
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-sm aspect-video rounded-2xl border-4 border-orange-600 bg-gray-800 flex items-center justify-center relative overflow-hidden mb-6"
          >
            {/* Grid overlay */}
            <svg
            ...
            <div className="relative z-5 w-48 h-32 bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg border-2 border-gray-600 flex items-center justify-center">
              <span className="text-gray-500 text-center text-sm">ID Card Back</span>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <motion.p
                ...
                className="text-sm font-mono text-orange-600 break-all"
              >
                {extractedData.mrzZone}
              </motion.p>
            ...
            >
              ...
              <motion.p
                ...
                className="text-sm font-bold text-neutral-dark leading-relaxed"
              >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-orange-900">Micro-text verified</p>
                  <p className="text-xs text-orange-800">
                    All security features are intact and verified.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="bg-neutral-light rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-semibold text-neutral-dark">Extraction Confidence</p>
                <p className="text-lg font-bold text-orange-600">98.4%</p>
              </div>
          ...
          {/* Continue Button */}
          <Link href="/product-extraction" className="mt-8">
            <motion.button
