  ...
  return (
    <>
      ...
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-50 glass-header text-[var(--foreground)] backdrop-blur-3xl shadow-[0_18px_45px_rgba(15,23,42,0.08)] dark:shadow-[0_18px_45px_rgba(0,0,0,0.45)]"
      >
